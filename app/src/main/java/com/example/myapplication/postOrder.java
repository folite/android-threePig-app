...
public class postOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(menuOrder.this,bundle.getString("select"),Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(postOrder.this,msg.getData().getString("response"),Toast.LENGTH_LONG).show();
            textView.setText(Html.fromHtml(msg.getData().getString("response")));

            //mWebView.loadData(msg.getData().getString("response"),"text/html",  "UTF-8");
